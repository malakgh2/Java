...
public class Resultat extends javax.swing.JFrame {
     ...
     */
    public int choix;
    public Resultat(int mark,int correct,int choix) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(102, 255, 204), 5));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Resultat(0,0,0).setVisible(true);
            }
        });
    }
