...
public class addq extends javax.swing.JFrame {
    ...
    public addq() {
        initComponents();
       try{ Connection con =QUIZZPOO.getcon();
        Statement st = con.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_READ_ONLY);

        ResultSet rs=st.executeQuery("select count(id) from profedit");
        if(rs.first())
        {
           int id=rs.getInt(1);
           id=id+1;
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(582, 740));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            PreparedStatement ps=con.prepareStatement("insert into profedit values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
            ps.setString(1,id);
            ...
            ps.setString(7, name2);
            ps.setString(8, opt1_2);
            ps.setString(9, opt2_2_);
            ps.setString(10, opt3_3);
            ps.setString(11, answer2);
            ps.setString(12, name3);
            ps.setString(13, opt1_3);
            ps.setString(14, opt2_3);
            ps.setString(15, opt3_3);
            ps.setString(16, answer3);
            ps.executeUpdate();
            JFrame jf=new JFrame();
            jf.setAlwaysOnTop(true);
